...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void setAnimation(boolean isAnimation) {
		if (mHeaderLayout != null && mHeaderLayout instanceof FlipLoadingLayout) {
			FlipLoadingLayout flipLoadingLayout = (FlipLoadingLayout) mHeaderLayout;
			flipLoadingLayout.setIsAnimation(isAnimation);
		}
	}
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			...
			case ROTATE:
			default:
				//此处修改可以切换下拉刷新顶部的动画==libin
				return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
			case FLIP:
				//此处修改可以切换上拉加载底部的动画==libin
